...
export interface OperationsConfiguration {
	...
	custom?: {
		GetUsers?: CustomizeQuery;
		CreateMessage?: CustomizeMutation;
		GetMessages?: CustomizeQuery;
		GetUser?: CustomizeQuery;
		UpdateAvatarId?: CustomizeMutation;
		UpdateProfile?: CustomizeMutation;
		UserCreate?: CustomizeMutation;
		UserUpdate?: CustomizeMutation;
		UserUpsert?: CustomizeMutation;
	};
}
