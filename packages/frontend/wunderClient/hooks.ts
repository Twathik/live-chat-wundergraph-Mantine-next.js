...
export const useQuery = {
	GetUsers: (options?: RequestOptions<never, GetUsersResponse>) => {
		const { client } = useWunderGraph();
		return Query(client.query.GetUsers, { requiresAuthentication: false }, options);
	},
	GetMessages: (options: RequestOptions<GetMessagesInput, GetMessagesResponse>) => {
		const { client } = useWunderGraph();
		return Query(client.query.GetMessages, { requiresAuthentication: false }, options);
	},
	GetUser: (options?: RequestOptions<never, GetUserResponse>) => {
		const { client } = useWunderGraph();
		return Query(client.query.GetUser, { requiresAuthentication: true }, options);
	},
};

export const useMutation = {
	CreateMessage: (options: MutateRequestOptions<CreateMessageInput>) => {
		const { client } = useWunderGraph();
		return Mutation(client.mutation.CreateMessage, { requiresAuthentication: true }, options);
	},
	UpdateAvatarId: (options: MutateRequestOptions<UpdateAvatarIdInput>) => {
		const { client } = useWunderGraph();
		return Mutation(client.mutation.UpdateAvatarId, { requiresAuthentication: true }, options);
	},
	UpdateProfile: (options: MutateRequestOptions<UpdateProfileInput>) => {
		const { client } = useWunderGraph();
		return Mutation(client.mutation.UpdateProfile, { requiresAuthentication: true }, options);
	},
	UserCreate: (options: MutateRequestOptions<UserCreateInput>) => {
		const { client } = useWunderGraph();
		return Mutation(client.mutation.UserCreate, { requiresAuthentication: false }, options);
	},
	UserUpdate: (options: MutateRequestOptions<UserUpdateInput>) => {
		const { client } = useWunderGraph();
		return Mutation(client.mutation.UserUpdate, { requiresAuthentication: true }, options);
	},
	UserUpsert: (options: MutateRequestOptions<UserUpsertInput>) => {
		const { client } = useWunderGraph();
		return Mutation(client.mutation.UserUpsert, { requiresAuthentication: false }, options);
	},
};

export const useLiveQuery = {
	GetUsers: (options?: SubscriptionRequestOptions) => {
		const { client } = useWunderGraph();
		return Subscription(client.liveQuery.GetUsers, { requiresAuthentication: false }, options);
	},
	GetMessages: (options: SubscriptionRequestOptions<GetMessagesInput>) => {
		const { client } = useWunderGraph();
		return Subscription(client.liveQuery.GetMessages, { requiresAuthentication: false }, options);
	},
	GetUser: (options?: SubscriptionRequestOptions) => {
		const { client } = useWunderGraph();
		return Subscription(client.liveQuery.GetUser, { requiresAuthentication: true }, options);
	},
};
